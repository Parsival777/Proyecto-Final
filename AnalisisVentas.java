...
public class AnalisisVentas {
    ...
    public static void registrarVentasMesa(int numeroMesa, int totalVentas) {
        // Implementación para registrar ventas de una mesa específica
        System.out.println("Registrando " + totalVentas + " ventas de la mesa " + numeroMesa);
        // Aquí se podrían agregar los datos al array de ventasPorHora
    }
